...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMarketingMetadata({
    title: isEnglish
      ? "Kronoma | Time tracking software for freelancers"
      : "Kronoma | Logiciel de suivi du temps pour freelances",
    description: isEnglish
      ? "Track hours, manage projects, and create international invoices. Kronoma helps freelancers turn time into invoices, with Swiss QR-bill support."
      : "Suivez vos heures, gerez vos projets et generez des factures internationales. Kronoma aide les freelances a transformer leur temps en factures, avec QR-facture pour les profils suisses.",
    path: "/landing",
    locale,
  });
}
...
export default async function Home() {
  ...
  const canonicalUrl = localizedAbsoluteUrl("/landing", locale);
  const homeJsonLd = [
    {
        ...
        <section id="pricing" className="mx-auto w-full maxW px-6 py-16">
          ...
          <div className="mt-10">
            <PricingCards
              ...
              gridMaxWidthClassName="max-w-[1020px]"
            />
          </div>
        </section>
